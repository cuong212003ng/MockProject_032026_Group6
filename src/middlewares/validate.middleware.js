...
const validateAvailability = [
  ...
  body('holiday_preferences.federal.selected_holiday_ids.*')
    .optional()
    .isInt({ min: 1 })
    .withMessage('federal selected_holiday_ids must contain integers'),
  ...
  body('holiday_preferences.state.state_id')
    .optional()
    .isInt({ min: 1 })
    .withMessage('state state_id must be an integer'),
  ...
  body('holiday_preferences.state.selected_holiday_ids.*')
    .optional()
    .isInt({ min: 1 })
    .withMessage('state selected_holiday_ids must contain integers'),
  handleValidation,
];
